...
/**
 * The {@code nBody.CollisionSystem} class represents a collection of particles
...
public class CollisionSystem {
    ...
    /**
     * Unit tests the {@code nBody.CollisionSystem} data type.
    ...
    public static void main(String[] args) {
        ...
        // or read from standard input
            ...
            In in = new In("./src/main/resources/data.in");
            int n = in.readInt();
            particles = new Particle[n];
            for (int i = 0; i < n; i++) {
